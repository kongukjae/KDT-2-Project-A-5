...
*/
const filePath = path.join(rootDirectory, "utils", "tagMaker.js"); // 1. 변경할 기존 파일의 경로와 파일명
const fileContent = readFileSync(filePath, "utf8"); // 2. 1번 기존 파일의 내용

const tsFilePath = path.join(rootDirectory, "utils", "tagMaker.ts"); // 3. 새 파일의 경로와 파일명
