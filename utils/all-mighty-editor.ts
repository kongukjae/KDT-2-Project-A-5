...
function positionEditor(
  ...
  callback?: (style: CSSStyleDeclaration) => void
) {
  ...
  if (typeof object === "object") {
    for (let i in object) {
      elementStyle.setProperty(i, object[i]);
    }
  }
  if (callback) {
...
function fontAndLayoutEditor(
  ...
  font: string | Record<string, string>,
  callback?: (style: CSSStyleDeclaration) => void
) {
  ...
  if (typeof font === "string") {
    ...
    for (let i in font) {
      parentStyle.setProperty(i, font[i]);
    }
  }
